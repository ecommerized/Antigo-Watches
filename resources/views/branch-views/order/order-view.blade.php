        ...
        <div class="modal-dialog modal-dialog-centered modal-mxwidth" style="--modal-mxwidth: 710px;">
            <div class="modal-content shadow-sm">
                <div class="modal-header pt-3 px-3 pb-0">
                    ...
                    <button type="button" class="close w-35 h-35 rounded-circle d-flex align-items-center justify-content-center bg-light position-relative" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@push('script_2')
    ...
    <script>
        ...
        function addDeliveryMan(id) {
            $.ajax({
                type: "GET",
                url: '{{ route('branch.orders.add-delivery-man', [$order['id'], ':delivery_man_id']) }}'.replace(':delivery_man_id', id),
